...
private Color frameBackgroundColor = Color.BLUE; // Warna latar belakang window
private Color textColor = Color.WHITE;  // Warna tulisan putih
private Color foregroundColor = Color.BLUE;  // Warna tulisan biru
...
f.getContentPane().setBackground(frameBackgroundColor);  // Atur warna background frame menjadi biru
ta=new JTextArea(30,60);
// Set warna tulisan pada frame
f.setForeground(Color.WHITE);
// Set warna tulisan pada status bar
statusBar=new JLabel("||       Ln 1, Col 1  ",JLabel.RIGHT);
// Set warna tulisan pada JTextArea (ta)
...
// Mengubah warna Text Menu Bar Menjadi Putih
...
f.setJMenuBar(mb);
// Mengubah Warna Background Menu Bar Menjadi Biru
